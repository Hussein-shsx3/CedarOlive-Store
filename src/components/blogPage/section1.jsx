  ...
  return (
    <section className="w-full container flex flex-col items-start mt-14">
      <div className="w-full my-5 px-5 md:px-0">
        <div className="flex flex-col md:flex-row bg-[#131313] justify-center items-stretch overflow-hidden h-auto min-h-[450px]">
          {/* Left - Text Block */}
          ...
          {/* Right - Main Image */}
          <div className="w-full md:w-[62%] h-48 sm:h-64 md:h-full">
            <img
